...
<body class="text-center">
	...
	<div id="container" class="container rounded-5 shadow" style="width: 500px; height: 650px;">
	    ...
	    <!-- 이하 생략 -->
		<br>
	    <form action="memberDeletePro" method="post" name="searchForm" id="deleteForm">
...
<script src="${pageContext.request.contextPath}/resources/js/member/memberDelete.js"></script>
