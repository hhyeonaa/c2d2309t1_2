...
<link href="${pageContext.request.contextPath}/resources/css/site_manage/manager.css" rel="stylesheet">
...
<script src="${pageContext.request.contextPath}/resources/js/site_manage/manager.js"></script>
