...
<!--         </div> -->
		...
		<c:forEach var="map" items="${resultList}">
	        <div class="col boardlist">
	            <div class="card h-100">
	                <a href="${pageContext.request.contextPath}/board/divideDetail?proWr=${map['PRO_WR']}&proDate=${map['PRO_DATE']}"><img src="${pageContext.request.contextPath}/resources/img/uploads/${map['IMG_NAME']}" class="card-img-top" alt="${map['IMG_NAME'] }" onerror="this.src='${pageContext.request.contextPath}/resources/img/member/noImage.jpg'"></a>
	                <div class="card-body">
	                    <span class="state1">${map.PRO_TC_CODE}</span>
	                    <span class="state2 PRO_STATE_${map.PRO_TSC}">${map.PRO_TSC_CODE}</span><br>
