		 		...
		 		<table class="table">
					...
					<tr>
						<c:forEach var="img" items="${relatedImg}">
							<td><a href="${pageContext.request.contextPath}/board/divideDetail?proWr=${img.PRO_WR}&proDate=${img.PRO_DATE}"><img src="${pageContext.request.contextPath}/resources/img/uploads/${img.IMG_NAME}" style="width: 134px; height: 134px;" onerror="this.src='${pageContext.request.contextPath}/resources/img/member/noImage.jpg'"></a></td>
						</c:forEach>
