...
<link href="${pageContext.request.contextPath}/resources/css/admin/header_menu.css" rel="stylesheet">
<style type="text/css">
body {
...
<script src="${pageContext.request.contextPath}/resources/js/admin/header_menu.js"></script>
</html>