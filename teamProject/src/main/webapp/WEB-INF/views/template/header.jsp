...
<!-- sticky menu -->
<link href="${pageContext.request.contextPath}/resources/css/stickyMenu.css" rel="stylesheet"/>

<!-- footer -->
<link href="${pageContext.request.contextPath}/resources/css/variables.css" rel="stylesheet">
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="btn-group">
			  	<button class="btn borderNone" type="button" data-bs-toggle="dropdown" id="button">
					<img src="${pageContext.request.contextPath}/resources/img/user.png" alt="로그인" onclick="" style="width: 40px; height: 40px;">
				</button>
